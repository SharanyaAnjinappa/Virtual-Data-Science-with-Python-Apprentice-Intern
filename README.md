...
The overall Titanic survival rate was approximately 38.38%.

Female passengers had substantially higher survival rates than male
passengers.

First-class passengers generally had higher survival rates than
passengers in lower classes.

The combination of gender and passenger class showed strong
differences in survival.

The Chi-Square test confirmed a statistically significant
relationship between gender and survival.

Logistic Regression achieved useful predictive performance, with a
